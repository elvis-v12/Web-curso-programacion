                                ...
                                <div class="details">
                                        <header class="details__header">
                                                <p class="details__header-text">
                                                        Python Practicando. Desde 0 hasta Desarrollador en PythonPython Practicando. Desde 0 hasta
                                                        Desarrollador en Python
                                                </p>
                                        </header>
                                        <main class="details__body">
                                                <section class="details__update">Ultima actualización: 9/2024</section>
                                                <section class="details__language">Español</section>
                                                <section class="details__info">
                                                        <span>25,5 horas de vídeo bajo demanda</span>
                                                        <span>21 artículos</span>
                                                        <span>147 recursos descargables</span>
