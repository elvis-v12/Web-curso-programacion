...
(() => {
      ...
      class CursoView {
                  ...
                  this.renderCourses().then(() => {
                        this.btncoursesEditCursos().forEach(btn => {
                              btn.addEventListener('click', (e) => {
                                    this.cursoService.findById({ code: btn.id.split('-')[2] }).then((curso) => {
                                          this.curso = curso;
                                          this.formCourseName().value = curso.titulo;
                                          this.formCoursePrice().value = curso.precio;
                                          this.formCourseLanguage().value = curso.idioma;
                                          this.formCourseDescription().innerHTML = curso.descripcion;
                                          this.formCourseSummary().innerHTML = curso.resumen;
                                          this.formCourseDetails().innerHTML = curso.detalles;
                                    });
            ...
            contenCourses() {
                  ...
                  this.btnSaveContentCourse().addEventListener('click', (e) => {
                        ...
                        this.curso.detalles = this.formCourseDetails().innerHTML;
      ...
      const cursoTemplade = ({ titulo, id_curso, portada, nombre_completo, precio, idioma }) => `
    <article class="courses__item" id="course-${id_curso}">
        <img src="${portada}" alt="${titulo}">
        <h3 class="courses__item_title">${titulo}</h3>
        ...
        <div class="courses__item_options">
            <button class="courses__item_option" id="btn-curso-${id_curso}">Editar Curso</button>
        </div>
    </article>
  `;
